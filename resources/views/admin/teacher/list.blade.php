            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: left">
                        <a href="{{ url('admin/teacher/add') }}" class="btn btn-primary"><i class="fa fa-user-plus"></i> ایجاد
                            استاد جدید</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title card-primary">جستجوی اطلاعات استاد</h3>
                            </div>
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">تعداد اساتید: {{ $getRecord->total() }}</h3>
                            </div>
                            <!-- /.card-header -->
